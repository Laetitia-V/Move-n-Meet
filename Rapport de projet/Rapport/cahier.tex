...
\includegraphics[scale=0.45]{bd.png}
\end{center}
...
Quatre personnes ont contribué au projet, au début Abdel et Aliénor se sont chargé de la création de notre base de donnée movenmeet. Thibault et Laëtita de la création du site (création des pages, liens, mise en forme générale). Par la suite, nous nous sommes divisés en dex groupes encore qui ont différé : Aliénor et Thibault se sont occupés de la recherche d'activités à faire à Montpellier, de la gestion des événements teporaires ainsi que des amélioration de mise en forme du site. Quant à Abdel et Laëtitia ils se sont chargé du compte utilisateur et tout ce qui concerne les activités de groupe.
...
\begin{description}
\begin{itemize}
\item Pour la page qui permet de trouver des activités selon ce que l'on souhaite faire nous envisageons le fait qu’un utilisateur puisse laisser un avis sur les activités et les évènements proposés sur le site. Ainsi selon la côte de popularité, les activités seraient plus ou moins mise en avant.
...
\newpage
\item Ci dessous le budget qui est prévu pour la suite lors des améliorations du site et création d'une application :
\end{itemize}
\end{description}
\begin{center}
\includegraphics[scale=0.5]{cout.png}
\end{center}
