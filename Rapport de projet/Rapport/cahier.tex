...
\textbf{URL de notre projet : https://github.com/Laetitia-V/Move-n-Meet}
...
Également nous avons chercher comment mettre en place certaines fonctionnalités du site sur internet à cause du retard dans certaines matières (JavaScript). 
...
\item La personne connectée peut consulter sur son profil ses activités de groupe passées et futures
\Mettre en place une messagerie entre les participants d'activités de groupe
\end{itemize}
\end{description}
...
Nous envisageons le fait qu'un utilisateur puisse laisser un avis sur les activités et les évènements proposés sur le site. Ainsi selon la côte de popularité, les activités seraient plus ou moins mise en avant. Par ailleurs, nous souhaitons mettre en place un système de promotions sur certaines activités qui apparaîtraient sur la page d'accueil. Pour cela, il faut que l'on se rapproche des prestataires pour établir avec eux les réductions possibles.
Par rapport aux activités de groupe, nous souhaitons mettre en place un système de rappel d'activité sur la boîte mail ou le téléphone des personnes concernées.
Nous souhaitons également développer l'application sur mobile avec un système de notifications qui rappellent les activités de groupe où nous sommes inscrits. 
