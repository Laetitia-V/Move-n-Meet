...
\item La personne connectée peut consulter sur son profil ses activités de groupe futures
\item  Messagerie entre les participants d'activités de groupe qui permet d'envoyer et de recevoir des messages
\end{itemize}
\end{description}
